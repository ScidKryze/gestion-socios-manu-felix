...
export default function LoginPage() {
  ...
  return (
    <AuthLayout>
      {/* Wrapper: imágenes laterales + card, todo centrado */}
      <div className="flex items-center justify-center w-full" style={{ maxWidth: '960px' }}>
        ...
        >
          ...
          <img
            ...
            style={{
              ...
              height: 'auto',
              display: 'block',
              filter: 'drop-shadow(-6px 0 25px rgba(200,16,46,0.5))',
              mixBlendMode: 'screen',
            }}
          />
        </div>
        ...
        {/* CARD CENTRAL */}
        <div
          className="w-full bg-white rounded-xl overflow-hidden flex-shrink-0"
          style={{
            maxWidth: '430px',
        ...
        >
          ...
          >
            ...
            <h1 className="relative z-10"
              style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '30px', letterSpacing: '5px', color: 'white', textTransform: 'uppercase', lineHeight: 1, textShadow: '0 2px 8px rgba(0,0,0,0.6)' }}>
              Peña Sevillista
            </h1>
            <p className="relative z-10 mt-1.5"
              style={{ fontFamily: 'Barlow, sans-serif', fontSize: '11px', letterSpacing: '3px', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', fontWeight: 600 }}>
        ...
        >
          ...
          <img
            ...
            style={{
              ...
              height: 'auto',
              display: 'block',
              filter: 'drop-shadow(6px 0 25px rgba(200,16,46,0.5)) brightness(1.1)',
              mixBlendMode: 'screen',
            }}
          />
        </div>
